...
public class DermatologieAdmin {
    ...
    public void initialize() {
        try {
            ...
            List<Specialiste> dermatologues = dao.getSpecialistesParSpecialite("Dermatologie");

            for (Specialiste sp : dermatologues) {
                ...
                info.setStyle("-fx-background-color: #fad6d6; -fx-background-radius: 15; -fx-padding: 10 20;");
                // Bouton RDV
                ...
                rdvButton.setStyle("-fx-background-color: #e93a3a; -fx-text-fill: white; -fx-background-radius: 20; -fx-padding: 5 10; -fx-cursor: hand;");
