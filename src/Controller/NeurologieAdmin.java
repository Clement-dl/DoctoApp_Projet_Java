...
public class NeurologieAdmin {
    ...
    public void initialize() {
        try {
            ...
            List<Specialiste> neurologues = dao.getSpecialistesParSpecialite("Neurologie");

            for (Specialiste sp : neurologues) {
                ...
                info.setStyle("-fx-background-color: #dbecd7; -fx-background-radius: 15; -fx-padding: 10 20;");
                // Bouton RDV
                ...
                rdvButton.setStyle("-fx-background-color: #4ea53e; -fx-text-fill: white; -fx-background-radius: 20; -fx-padding: 5 10; -fx-cursor: hand;");
