...
public class DentisteAdmin {
    ...
    public void initialize() {
        try {
            ...
            List<Specialiste> dentistes = dao.getSpecialistesParSpecialite("Dentiste");

            for (Specialiste sp : dentistes) {
                ...
                info.setStyle("-fx-background-color: #dcceeb; -fx-background-radius: 15; -fx-padding: 10 20;");
                ...
                rdvButton.setStyle("-fx-background-color: #54119f; -fx-text-fill: white; -fx-background-radius: 20; -fx-padding: 5 10; -fx-cursor: hand;");
