...
public class RadiologieAdmin {
    ...
    public void initialize() {
        try {
            ...
            List<Specialiste> radiologues = dao.getSpecialistesParSpecialite("Radiologie");

            for (Specialiste sp : radiologues) {
                ...
                info.setStyle("-fx-background-color: #fae6d8; -fx-background-radius: 15; -fx-padding: 10 20;");
                ...
                rdvButton.setStyle("-fx-background-color: #e98542; -fx-text-fill: white; -fx-background-radius: 20; -fx-padding: 5 10; -fx-cursor: hand;");
